...
import { enableSimulatedPayments } from "@/lib/arc-config";
...
export async function POST(request: Request, { params }: RouteContext) {
  if (!enableSimulatedPayments) {
    return paymentError(
      "SIMULATED_PAYMENTS_DISABLED",
      "Simulated payments are disabled for this environment.",
      403,
    );
  }
