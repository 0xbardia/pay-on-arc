  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          <Link
            className="inline-flex h-10 items-center gap-2 rounded-md border border-border bg-white/[0.03] px-4 text-sm text-slate-200 transition hover:bg-white/[0.06]"
