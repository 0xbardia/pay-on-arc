    ...
    <div className="space-y-5">
      ...
      {apiKeys.length === 0 ? (
        <div className="rounded-xl border border-dashed border-white/10 bg-slate-950/40 p-8 text-center">
          <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-xl bg-violet-500/15 text-violet-200">
            ...
            {apiKeys.map((apiKey) => (
              ...
              >
                ...
                >
                  ...
                  <Copy className="h-3.5 w-3.5 shrink-0 text-violet-300" aria-hidden="true" />
                </button>
      ...
      {revokingKey ? (
        <div className="fixed inset-0 z-[100] flex min-h-dvh items-center justify-center overflow-y-auto bg-black/80 p-4 py-8 backdrop-blur-md sm:p-6">
          <div className="relative my-auto w-full max-w-md rounded-2xl border border-white/10 bg-[#0B0F19] p-5 shadow-premium ring-1 ring-white/5 sm:p-6">
